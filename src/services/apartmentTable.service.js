...
const getAllManageUSerAttendance = async (id,date,fromtime,totime,page)=>{
  ...
  if(id !='null'&&date !='null'&&fromtime !='null'&&totime!='null'){
    //  match=[{ Uid: { $eq: id }},{ date: { $eq: date }},{ time:{ $gte: from,$lte: to}},{active:{$eq:true}}];
     match=[{ Uid: { $eq: id }},{ date: { $eq: date }},{ time:{ $gte: to}},{ time:{ $lte: from}},{active:{$eq:true}}];
  }
...
const getAllApartment = async (id,districtId,zoneId,wardId,streetId,status,page) => {
 ...
 if(id !='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId != 'null'&& status == check){
    match=[{ Uid: { $eq: id }},{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId }},{ Strid:{ $eq: streetId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
    ...
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{'streetsdata.closed':{$eq:'close'}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
  else if(id !='null'&&districtId =='null'&&zoneId !='null'&&wardId=='null'&&streetId == 'null'&& status == check){
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
    ...
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:'close'}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
  else if(id !='null'&&districtId =='null'&&zoneId =='null'&&wardId!='null'&&streetId == 'null'&& status == check){
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
  else if(id !='null'&&districtId =='null'&&zoneId =='null'&&wardId!='null'&&streetId == 'null'&& status != 'null'){
  ...
  ////
    ...
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:'close'}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
  else if(id !='null'&&districtId =='null'&&zoneId !='null'&&wardId!='null'&&streetId == 'null'&& status == check){
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
  }
  else if(id !='null'&&districtId =='null'&&zoneId !='null'&&wardId!='null'&&streetId == 'null'&& status != 'null'){
    match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{status:{$eq:status}}]
  }
else if(id !='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId != 'null'&& status !='null'){
 ...
 //
  ...
  match=[{ Uid: { $eq: id }},{ Strid:{$eq:streetId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId =='null'&&zoneId =='null'&&wardId=='null'&&streetId != 'null'&& status == check1){
  ...
  match=[{ Uid: { $eq: id }},{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{ Strid:{$eq:streetId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId !='null'&&zoneId =='null'&&wardId=='null'&&streetId != 'null'&& status == check1){
  ...
  match=[{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id =='null'&&districtId !='null'&&zoneId =='null'&&wardId =='null'&&streetId == 'null'&& status == check1){
  ...
  match=[{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{$eq:zoneId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&&wardId =='null'&&streetId == 'null'&& status == check1){
  ...
  match=[{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{ Strid: { $eq: streetId }},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&&wardId !='null'&&streetId != 'null'&& status == check1){
  ...
  match=[{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId == 'null'&& status == check1){
  ...
  match=[{ Uid: { $eq: id }},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId =='null'&&zoneId =='null'&&wardId=='null'&&streetId == 'null'&& status == check1){
  match=[{ Uid: { $eq: id }},{'streetsdata.closed':{$eq:'close'}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId !='null'&&zoneId =='null'&&wardId=='null'&&streetId == 'null'&& status == check){
  match=[{ Uid: { $eq: id }},{'manageusersdata.preferredDistrict': { $eq: districtId }},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId !='null'&&zoneId =='null'&&wardId=='null'&&streetId == 'null'&& status == check1){
  ...
  match=[{ Uid: { $eq: id }},{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId !='null'&&zoneId !='null'&&wardId=='null'&&streetId == 'null'&& status == check1){
  ...
  match=[{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:null}},{ Strid: { $eq: streetId }},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId != 'null'&& status == check1){
  match=[{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{ Strid: { $eq: streetId }},{'streetsdata.closed':{$eq:'close'}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
...
//  }
  ...
  match=[{ Uid: { $eq: id }},{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{'streetsdata.closed':{$eq:null}},{status:{$ne:'Approved'}},{status:{$ne:'Rejected'}},{status:{$eq:""}}]
}
else if(id !='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId == 'null'&& status == check1){
  ...
  console.log("wfd")
  match=[{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{ Strid: { $eq: streetId }},{status:{$eq:status}}]
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId == 'null'&& status != 'null'){
  match=[{'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{status:{$eq:status}}]
}
else if(id !='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId == 'null'&& status != 'null'){
  ...
  match=[{ Uid: { $eq: id }},{'manageusersdata.preferredDistrict': { $eq: districtId }},{status:{$eq:status}}]
}
else{
   match=[{ _id: { $ne: null }}]
 }
 ...
 console.log(match)
  ...
  const getAllApartmentAndShop = async(id,districtId,zoneId,wardId,streetId,status,page)=>{ 
    ...
    if(id !='null'&&districtId !='null'&&zoneId !='null'&&wardId!='null'&&streetId != 'null'&& status !='null'){
      mat={$and:[{'manageusersdata._id':{ $eq: id }},{'manageusersdata.preferredDistrict':{ $eq: districtId }},{'manageusersdata.preferredZone':{$eq:zoneId}},{'manageusersdata.preferredWard':{$eq:wardId}},{ _id:{$eq:streetId}},{filter:{$eq:status}}]}
   }
   else if(id !='null'&&districtId =='null'&&zoneId =='null'&&wardId =='null'&&streetId == 'null'&& status =='null'){
  ...
  mat={$and:[{'manageusersdata.preferredDistrict':{ $eq: districtId }},{'manageusersdata.preferredZone':{$eq:zoneId}},{ filter:{ $eq: status}}]}
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&& wardId!='null'&&streetId == 'null'&& status !='null'){
  mat={$and:[{'manageusersdata.preferredDistrict':{ $eq: districtId }},{'manageusersdata.preferredZone':{$eq:zoneId}},{'manageusersdata.preferredWard':{$eq:wardId}},{ filter:{ $eq: status}}]}
}
else if(id =='null'&&districtId !='null'&&zoneId !='null'&& wardId!='null'&&streetId != 'null'&& status !='null'){
  mat={$and:[{'manageusersdata.preferredDistrict':{ $eq: districtId }},{'manageusersdata.preferredZone':{$eq:zoneId}},{'manageusersdata.preferredWard':{$eq:wardId}},{ _id:{$eq:streetId}},{ filter:{ $eq: status}}]}
}
// sdef
else if(id !='null'&&districtId =='null'&&zoneId =='null'&& wardId=='null'&&streetId == 'null'&& status !='null'){
  ...
  mat={$and:[{  'manageusersdata._id': { $eq: id }},{'manageusersdata.preferredDistrict':{ $eq: districtId }},{ filter:{ $eq: status}}]}
}
else if(id !='null'&&districtId !='null'&&zoneId !='null'&& wardId=='null'&&streetId == 'null'&& status !='null'){
 mat={$and:[{  'manageusersdata._id': { $eq: id }},{'manageusersdata.preferredDistrict':{ $eq: districtId }},{'manageusersdata.preferredZone':{$eq:zoneId}},{ filter:{ $eq: status}}]}
}
else if(id !='null'&&districtId !='null'&&zoneId !='null'&& wardId!='null'&&streetId == 'null'&& status !='null'){
 mat={$and:[{  'manageusersdata._id': { $eq: id }},{'manageusersdata.preferredDistrict':{ $eq: districtId }},{'manageusersdata.preferredZone':{$eq:zoneId}},{'manageusersdata.preferredWard':{$eq:wardId}},{ filter:{ $eq: status}}]}
}
  else if(id !='null'&&districtId !='null'&&zoneId =='null'&&wardId == 'null'&&streetId == 'null'&& status =='null'){
      mat={$and:[{'manageusersdata._id': { $eq: id }},{ 'manageusersdata.preferredDistrict': { $eq: districtId }}]}
   }
   else if(id !='null'&&districtId !='null'&&zoneId !='null'&& wardId=='null'&&streetId == 'null'&& status =='null'){
     mat={$and:[{  'manageusersdata._id': { $eq: id }},{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}}]}
   }
   else if(id !='null'&&districtId !='null'&&zoneId !='null'&& wardId!='null'&&streetId == 'null'&& status =='null'){
     mat={$and:[{  'manageusersdata._id': { $eq: id }},{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}}]}
   }
   else if(id !='null'&&districtId !='null'&&zoneId !='null'&& wardId!='null'&&streetId != 'null'&& status =='null'){
    mat={$and:[{ 'manageusersdata._id': { $eq: id }},{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredZone':{ $eq: zoneId}},{ 'manageusersdata.preferredWard':{ $eq: wardId}},{ _id:{ $eq: streetId}}]}
    ...
    mat={$and:[{ 'manageusersdata.preferredDistrict': { $eq: districtId }},{ 'manageusersdata.preferredWard':{ $eq: wardId}}]}
  }else if(id =='null'&&districtId !='null'&&zoneId =='null'&& wardId=='null'&&streetId != 'null'&& status =='null'){
