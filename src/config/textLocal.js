...
//   message = urlencodeed(
//     'Dear '+user.name+', thank you for registering with Kapture(An Uyarchi Solutions company). Your OTP for logging into the account is ' +
//       OTPCODE +
//       ' .'
//   );
//   data = 'send/?apikey=' + apiKey + '&numbers=' + numbers + '&sender=' + sender + '&message=' + message;
//   var options = 'https://api.textlocal.in/' + data;
  return await saveOtp.saveOtp(contact,OTPCODE,user)
