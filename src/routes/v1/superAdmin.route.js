...
router.route('/').post(superAdminProofs.fields([{name:"idProof"}, {name:"addressProof"}, {name:"bioData"}]), superAdminController.createSuperAdmin).get(superAdminController.superAdminList);
